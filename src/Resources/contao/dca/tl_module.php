...
$GLOBALS['TL_DCA']['tl_module']['palettes']['turnierpaare_list'] = '{title_legend},name,headline,type;{turnierpaare_select_legend},tl_turnierpaare_selectCouples;{turnierpaaredetail_legend},tl_turnierpaare_detail;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
/*
Palette für das Modul turnierpaare_ergebnisse_list
*/
$GLOBALS['TL_DCA']['tl_module']['palettes']['turnierpaare_ergebnisse_list'] = '{title_legend},name,headline,type;{turnierpaaredetail_legend},tl_turnierpaare_detail;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
/*
...
$GLOBALS['TL_DCA']['tl_module']['fields']['tl_tanzpartnervermittlung_email_absender'] = array(
       'label' => &$GLOBALS['TL_LANG']['tl_module']['tl_tanzpartnervermittlung_email_absender'],
	'exclude'                 => true,
  'inputType'               => 'text',
  'eval'                    => array('mandatory'=>true, 'rgxp'=>'email', 'maxlength'=>255, 'unique'=>true, 'decodeEntities'=>true, 'tl_class'=>'w50'),
  'sql'                     => "varchar(255) NOT NULL default ''"
...
$GLOBALS['TL_DCA']['tl_module']['fields']['tl_tanzpartnervermittlung_email_name'] = array(
       'label' => &$GLOBALS['TL_LANG']['tl_module']['tl_tanzpartnervermittlung_email_name'],
       'exclude'                 => true,
 			'sorting'                 => true,
 			'flag'                    => 1,
 			'search'                  => true,
...
$GLOBALS['TL_DCA']['tl_module']['fields']['tl_tanzpartnervermittlung_email_subject'] = array(
       'label' => &$GLOBALS['TL_LANG']['tl_module']['tl_tanzpartnervermittlung_email_subject'],
       'exclude'                 => true,
 			'sorting'                 => true,
 			'flag'                    => 1,
 			'search'                  => true,
